...
const SmartSelect = ({
  ...
  const baseClasses = "w-full px-4 py-2 border rounded-lg transition-all duration-200 appearance-none bg-white"
  ...
  return (
    <div className="relative">
      ...
      <select
        ...
        disabled={disabled}
        className={`${selectClasses} text-base md:text-sm min-h-[44px] md:min-h-0 touch-manipulation`}
        {...props}
      >
        {options.map((option) => (
